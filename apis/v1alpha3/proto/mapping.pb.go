...
func (x *GroupMapping) GetGanpati() *Ganpati {
	if x != nil {
		if x, ok := x.Source.(*GroupMapping_Ganpati); ok {
			return x.Ganpati
		}
	}
	return nil
...
type GroupMapping_Ganpati struct {
	Ganpati *Ganpati `protobuf:"bytes,1,opt,name=ganpati,proto3,oneof"`
}

type GroupMapping_GoogleGroups struct {
	GoogleGroups *GoogleGroups `protobuf:"bytes,2,opt,name=google_groups,json=googleGroups,proto3,oneof"`
}

func (*GroupMapping_Ganpati) isGroupMapping_Source() {}
...
type GroupMapping_Github struct {
	Github *GitHub `protobuf:"bytes,3,opt,name=github,proto3,oneof"`
}

type GroupMapping_Gitlab struct {
	Gitlab *GitLab `protobuf:"bytes,4,opt,name=gitlab,proto3,oneof"`
}
...
var file_proto_mapping_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xec, 0x01, 0x0a, 0x0c, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4d, 0x61, 0x70,
	0x70, 0x69, 0x6e, 0x67, 0x12, 0x2e, 0x0a, 0x07, 0x67, 0x61, 0x6e, 0x70, 0x61, 0x74, 0x69, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x47, 0x61, 0x6e, 0x70, 0x61, 0x74, 0x69, 0x48, 0x00, 0x52, 0x07, 0x67, 0x61, 0x6e,
	0x70, 0x61, 0x74, 0x69, 0x12, 0x3e, 0x0a, 0x0d, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5f, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72,
	...
	0x6f, 0x75, 0x70, 0x73, 0x12, 0x2b, 0x0a, 0x06, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x18, 0x03,
	...
	0x62, 0x12, 0x2b, 0x0a, 0x06, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x18, 0x04, 0x20, 0x01, 0x28,
...
var file_proto_mapping_proto_goTypes = []any{
	...
	(*Ganpati)(nil),          // 5: proto.api.Ganpati
	(*GoogleGroups)(nil),     // 6: proto.api.GoogleGroups
	(*GitHub)(nil),           // 7: proto.api.GitHub
	(*GitLab)(nil),           // 8: proto.api.GitLab
}
var file_proto_mapping_proto_depIdxs = []int32{
	5, // 0: proto.api.GroupMapping.ganpati:type_name -> proto.api.Ganpati
	6, // 1: proto.api.GroupMapping.google_groups:type_name -> proto.api.GoogleGroups
	7, // 2: proto.api.GroupMapping.github:type_name -> proto.api.GitHub
	8, // 3: proto.api.GroupMapping.gitlab:type_name -> proto.api.GitLab
	0, // 4: proto.api.GroupMappings.mappings:type_name -> proto.api.GroupMapping
	2, // 5: proto.api.UserMappings.mappings:type_name -> proto.api.UserMapping
	1, // 6: proto.api.TeamLinkMappings.group_mappings:type_name -> proto.api.GroupMappings
	3, // 7: proto.api.TeamLinkMappings.user_mappings:type_name -> proto.api.UserMappings
