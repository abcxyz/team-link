...
func (x *Ganpati) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Ganpati) ProtoMessage() {}

func (x *Ganpati) ProtoReflect() protoreflect.Message {
	mi := &file_proto_group_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Ganpati.ProtoReflect.Descriptor instead.
func (*Ganpati) Descriptor() ([]byte, []int) {
	return file_proto_group_proto_rawDescGZIP(), []int{3}
}

func (x *Ganpati) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_group_proto_rawDesc = []byte{
	...
	0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x22, 0x19, 0x0a, 0x07, 0x47, 0x61, 0x6e, 0x70,
	0x61, 0x74, 0x69, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x42, 0x91, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x0a, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x50, 0x72, 0x6f, 0x74,
...
var file_proto_group_proto_goTypes = []any{
	...
	(*Ganpati)(nil),      // 3: proto.api.Ganpati
}
